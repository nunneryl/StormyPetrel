    ...
    <article className="mx-auto max-w-[700px] px-4 sm:px-6 py-10 sm:py-14">
      ...
      <div className="space-y-6 text-base sm:text-lg text-text-primary leading-relaxed">
        <p>
          ...
          Sailors considered them omens. When the petrels showed up, a storm
          was coming. They read the ocean before we had models, before we had
          buoys, before anyone thought to charge you for it. They&rsquo;re the
          original surf forecasters.
        </p>

        <p>
          Every wave starts with public data. Government buoys measure the
          swell. NOAA supercomputers model the nearshore. Tide tables are
